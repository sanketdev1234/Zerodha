...
const LoginForm = () => {
  ...
  const handleSubmitfor2f = async (e) => {
    ...
    if (YES2FA) {
      ...
      try {
        const response = await axios.post('/mfa/setup2fa', {
          headers: {
            'Content-Type': 'application/json'
          },
          withCredentials: true
      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-12">
              ...
              <div className="success-alert" role="alert">
                <div className="d-flex align-items-center">
                  ...
                  <div>
                    ...
                    <br />
                    <small>You have logged in successfully.</small>
                  </div>
                </div>
              </div>
            )}
              ...
              <div className="card-body">
                ...
                <div className="mt-3">
                  ...
                  >
                    {isSubmittingfor2f ? (
                      <>
                        <span className="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"></span>
                        {YES2FA ? "Disabling 2FA..." : "Enabling 2FA..."}
                      </>
                    ) : (
                ...
                <div className="footer-text">
                  <p className="text-muted mb-0">
                    New to our community? <Link to='/signup'>Sign up here</Link>
                  </p>
                </div>
              </div>
            </div>
            ...
            {qrurl && (
              <div className="qr-section mx-auto" style={{ maxWidth: '480px' }}>
                <h5>Setup Two-Factor Authentication</h5>
                <p>Scan this QR code with your authenticator app (Google Authenticator, Authy, etc.)</p>
                <img src={qrurl} alt="QR Code for 2FA Setup" />
                <p className="small">After scanning, enter the 6-digit code from your app above</p>
              </div>
            )}
          </div>
        </div>
